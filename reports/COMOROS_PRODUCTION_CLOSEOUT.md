...
Independent full review: **229/229** records (81 entities, 80 relationships, 40 claims, 18 sources, 5 denominators, 5 coverage). Required mutations: **34/34**, adding guards for UNESCO unpublishing, de-sharing the seven-State element, wrong year, submitting-States tamper, losing a constitutional article, silencing the Mayotte note, unpublishing an official language, publishing a minority language, losing the ISO code set, inserting a speaker share, medina-as-current, medina administrative parent, wrong island, medina as city, claims attached to a medina, medina source upgrade, publishing weak depth, promoting a dialect, unglossed dialect entries, property-area tamper, publishing component names, source-tier inflation, claiming exclusivity in a classification, and layer-denominator inflation.
