...
3. ✅ **Cultural local knowledge — cycle 3 DONE (2026-08-17):** 19 classified claims entered unpublished (12 dishes with المندي enforced `shared`, 5 dialect profiles with lexicon samples, 2 non-Arabic languages at `probable`). Next: dress/crafts/markets domains, lane-level anchoring, and field-dated lexical corpus.
