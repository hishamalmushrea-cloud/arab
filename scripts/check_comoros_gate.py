...
def main() -> int:
    ...
    gate.require(len(after_sources) == 18 and before_sources == after_sources, "comoros_source_idempotence", f"atomic sources={len(after_sources)}/18, unchanged={before_sources == after_sources}")
    ...
    report = {"schema_version": "2.0.0", "country_code": "KM", "snapshot_date": "2026-09-20", "status": "pass" if not gate.errors else "fail", "checks": gate.checks, "errors": gate.errors}
