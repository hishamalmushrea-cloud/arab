...
def main():
 ...
 if len(depth)!=19 or any(c.get('published') for c in depth):find.append({'severity':'P1','record_id':'depth','message':'19 unpublished cultural depth claims required'})
