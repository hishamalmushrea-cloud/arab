...
def main() -> None:
    ...
    report = {"schema_version": "2.0.0", "country_code": "BH", "snapshot_date": "2026-09-20", "selection_method": "Full review of every Bahrain production record because each family is small; sorted stable IDs.", "families": families}
