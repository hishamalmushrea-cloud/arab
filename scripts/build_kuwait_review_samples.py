...
def main():
 ...
 x={'schema_version':'2.0.0','country_code':'KW','snapshot_date':'2026-09-20','selection_method':'Full review of small Kuwait production population; stable sorted IDs.','families':f};write_json(ROOT/'data/review/kuwait_review_samples.json',x);write_json(ROOT/'reports/kuwait_review_samples.json',x);print('Kuwait full review sample',sum(v['sample_size'] for v in f.values()))
