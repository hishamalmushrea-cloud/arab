...
| CLM-YE-CRAFT-4563853636005149 | ENT-YE-GOVERNORATE-02 | craft_custom | {'description': 'صناعة الأواني الفخارية والحجرية ومنها المدرة التي تقدم فيها السلتة فائرة', 'name': 'الفخار والأواني الحجرية', 'note': 'المرتفعات'} | regional | low | reported | SRC-YE-CRAFTS-MARKETS-MIRROR | Craft entry: الفخار والأواني الحجرية |
| CLM-YE-CRAFT-864B0C63A63350E0 | ENT-YE-GOVERNORATE-02 | craft_custom | {'description': 'استخراج العقيق وصقله وتركيبه في الخواتم والحلي؛ العقيق اليمني ذائع الصيت عربيًا', 'name': 'العقيق اليمني', 'note': 'مرتبط بصنعاء ومناطق المرتفعات'} | national | low | reported | SRC-YE-CRAFTS-MARKETS-MIRROR | Craft entry: العقيق اليمني |
| CLM-YE-CRAFT-9EE21F72708A5B13 | ENT-YE-COUNTRY | craft_custom | {'description': 'نسج المعوز والثياب التقليدية؛ لكل منطقة أنماطها وألوانها', 'name': 'النسيج التقليدي', 'note': 'المعوز الحضرمي أغلاها'} | national | low | reported | SRC-YE-CRAFTS-MARKETS-MIRROR | Craft entry: النسيج التقليدي |
| CLM-YE-CRAFT-DD9D2F2A737D5008 | ENT-YE-GOVERNORATE-02 | craft_custom | {'description': 'صياغة الجنبية والحلي النسائية من الفضة والذهب مع الأحجار كالعقيق والمرجان والكهرمان؛ تجارة ذهب وفضة يمنية موغلة في القدم', 'name': 'صياغة الفضة والجنابي', 'note': 'مراكزها التاريخية صنعاء وحضرموت'} | national | low | reported | SRC-YE-CRAFTS-MARKETS-MIRROR | Craft entry: صياغة الفضة والجنابي |
...
| CLM-YE-DRESS-104FFC604AFA5F11 | ENT-YE-COUNTRY | clothing_item | {'description': 'خنجر مقوس يحمل على الخصر في حزام مزخرف (الزنة)؛ نصل فولاذي ومقبض من قرن منقوش مطعم بالفضة وجراب خشبي مكسو؛ رمز هوية ومكانة اجتماعية يتوارث لا سلاح عملي', 'gender': 'رجالي', 'name': 'الجنبية', 'note': 'لكل منطقة طراز: الصنعاني والحضرمي والحاشدي وغيرها'} | national | low | reported | SRC-YE-DRESS-PAGES-MIRROR | Dress entry: الجنبية |
| CLM-YE-DRESS-3534520321215E88 | ENT-YE-GOVERNORATE-05 | clothing_item | {'description': 'أسماء محلية دقيقة لأزياء ريفية: عرج النخلة في الحجرية، رجل الحمامة في حيفان، المدرجات في أرياف صبر، سلاسل المطر في صبر وشرعب، النخيل في الزعازع', 'gender': 'نسائي', 'name': 'أزياء أرياف تعز المسماة', 'note': 'توثيق نادر لأسماء الأزياء على مستوى المديرية'} | local | low | reported | SRC-YE-DRESS-PAGES-MIRROR | Dress entry: أزياء أرياف تعز المسماة |
| CLM-YE-DRESS-7BBE925E17C95E61 | ENT-YE-GOVERNORATE-04 | clothing_item | {'description': 'ثوب نساء دوعن الداخلية مع حزام حضرمي فضي، يلبس في الأعراس', 'gender': 'نسائي', 'name': 'الثوب الدوعني', 'note': 'حضرموت الداخلية'} | local | low | reported | SRC-YE-DRESS-PAGES-MIRROR | Dress entry: الثوب الدوعني |
| CLM-YE-DRESS-88BA2DFC4BE454ED | ENT-YE-GOVERNORATE-06 | clothing_item | {'description': 'ثوب قماش خفيف تلبسه نساء تهامة والجنوب في البيت؛ يناسب حرارة الساحل ورطوبته', 'gender': 'نسائي', 'name': 'الدرع التهامي', 'note': 'تهامة'} | regional | low | reported | SRC-YE-DRESS-PAGES-MIRROR | Dress entry: الدرع التهامي |
| CLM-YE-DRESS-A72929C2C8945652 | ENT-YE-COUNTRY | clothing_item | {'description': 'قطعة قماش مستطيلة تلف على أسفل الجسم من الخصر إلى منتصف الساق؛ لباس الرجل اليمني الأساسي وخاصة في المناطق الساحلية والجنوبية', 'gender': 'رجالي', 'name': 'المعوز', 'note': 'أنواعه المناطقية: البيضاني واللحجي والحضرمي (أغلاها بخيوطه الذهبية والفضية) والشبواني والتهامي والواسعي'} | national | low | reported | SRC-YE-DRESS-PAGES-MIRROR | Dress entry: المعوز |
| CLM-YE-DRESS-BDE7BACBBE8E5DA7 | ENT-YE-GOVERNORATE-04 | clothing_item | {'description': 'ثوب نساء الساحل الحضرمي قصير من الأمام طويل من الخلف من قماش القطيفة المشجر برقبة على شكل العين، يلبس ثاني أيام الزواج مع مروحة من سعف النخل وحزام فضي صغير', 'gender': 'نسائي', 'name': 'الثوب الشحري', 'note': 'الشحر والمكلا وغيل باوزير وبروم ميفع'} | local | low | reported | SRC-YE-DRESS-PAGES-MIRROR | Dress entry: الثوب الشحري |
| CLM-YE-DRESS-CFB4C72526885548 | ENT-YE-GOVERNORATE-02 | clothing_item | {'description': 'فستان مطرز إلى الركبة بأكمام طويلة مع غطاء رأس مزدان بالحلي الفضية يسمى العصبة أو المصعر، والقرقوش غطاء رأس يميز الطفلة عن المتزوجة', 'gender': 'نسائي', 'name': 'الزنة الصنعانية والعصبة', 'note': 'صنعاء وضواحيها'} | local | low | reported | SRC-YE-DRESS-PAGES-MIRROR | Dress entry: الزنة الصنعانية والعصبة |
...
| CLM-YE-MARKET-D5FAAAEB625D596D | ENT-YE-GOVERNORATE-02 | market_presence | {'description': 'السوق الأشهر في صنعاء القديمة؛ شبكة أسواق متخصصة داخل المدينة المسورة تشمل أسواق الحطب والكبوس والقشر وميزان الزبيب والبهارات والذهب والحلقة وفيه سمسرة', 'name': 'سوق الملح', 'note': 'اسم حارة موثقة ضمن حارات صنعاء القديمة الـ69 في طبقة الحارات'} | local | low | reported | SRC-YE-CRAFTS-MARKETS-MIRROR | Market entry: سوق الملح |
| CLM-YE-MARKET-DD13A4AD70FC5A8C | ENT-YE-GOVERNORATE-05 | market_presence | {'description': 'ميناء المخا أعطى اسمه لقهوة الموكا عالميًا؛ أسواق البن التاريخية التي صدرت البن اليمني إلى العالم', 'name': 'أسواق المخا التاريخية', 'note': 'المخا مديرية موثقة ضمن مديريات تعز في طبقة المديريات'} | historical | low | reported | SRC-YE-CRAFTS-MARKETS-MIRROR | Market entry: أسواق المخا التاريخية |
| CLM-YE-MARKET-E2BD77BFE2955CD4 | ENT-YE-GOVERNORATE-04 | market_presence | {'description': 'أسواق وادي حضرموت التجارية المرتبطة بطرق القوافل والهجرة الحضرمية', 'name': 'أسواق تريم وسيئون', 'note': 'تريم وسيئون مديريتان موثقتان في طبقة المديريات'} | local | low | reported | SRC-YE-CRAFTS-MARKETS-MIRROR | Market entry: أسواق تريم وسيئون |
...
| SRC-YE-DRESS-PAGES-MIRROR | E | Yemeni traditional dress — embassy, press, and encyclopedic mirror pages | Embassy/press/encyclopedic mirror pages on Yemeni traditional dress | — | 2026-08-17 | Factual extraction with attribution; publisher reuse terms not stated | https://ar.wikipedia.org/wiki/%D8%A7%D9%84%D8%B2%D9%8A_%D8%A7%D9%84%D9%8A%D9%85%D9%86%D9%8A |
